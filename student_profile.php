	...
	<div class="col-md-4">
		...
		<div class="panel panel-default" style="background-color:#393f4d;" id="panel-margin">
			...
			<div class="panel-body">
				...
				<h4 style="color:#fff;">Nombre: <label class="pull-right"><?php echo $fetch['firstname']." ".$fetch['lastname']?></label></h4>
				<h4 style="color:#fff;">Género: <label class="pull-right"><?php echo $fetch['gender']?></label></h4>
				<h4 style="color:#fff;">Semestre: <label class="pull-right"><?php echo $fetch['yr&sec']?></label></h4>
				<h3 style="color:#fff;">Cargar Archivo</h3>
